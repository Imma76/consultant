                    ...
                    : ElevatedButton(
                        onPressed: () async {
                          ...
                          if (currentIndex == 2) {
                            ...
                            if(authController.cvUrl == null){
                              showToast("upload your cv before proceeding");
                              return;
                            }
                          }
  ...
  Widget build(BuildContext context, ref) {
    ...
    return Column(
      ...
      children: [
        ...
        Gap(24.h),
        Text(
          'Select local government of origin',
          style: GoogleFonts.poppins(
              color: AppTheme.black2,
              fontSize: 16.sp,
              fontWeight: FontWeight.w400),
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        authController.cvFile != null
                            ? '${authController.cvFile?.files.single.name}'
                            : '',
                        softWrap: true,
                  ...
                  decoration: BoxDecoration(
                    border: Border.all(color: AppTheme.white2),
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
                ...
                child: Container(
                  child: Row(
                    ...
                    children: [
                      GestureDetector(
                          onTap: () {
                            authController.pickMedicalLicense();
                          },
                          child: Container(
                            width: 126.w,
                            height: 49.h,
                      ...
                      Text(
                        authController.medicalLicense != null
                            ? '${authController.medicalLicense?.files.single.name}'
                            : '',
                        softWrap: true,
                        overflow: TextOverflow.ellipsis,
                        style: TextStyle(fontSize: 10),
          ...
          Gap(24.h),
          Text(
            'Write a brief history about yourself',
            style: GoogleFonts.poppins(
                color: AppTheme.black2,
                fontSize: 16.sp,
                fontWeight: FontWeight.w400),
